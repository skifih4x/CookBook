...
extension DetalViewController {
    func setupHowMakeLabel() {
        ...
        howMakeLabel.text = "erferferferferferfwerfwerfwerfwervwercwercwerc"
//        howMakeLabel.text = "1234123412 grhkfdg[khd'fg fgjh [d[fgваыхзпшdgfsgdsfgdsfgdfgdfgdfgfgfdghdfghfdghfdghdfghdfghfdghfdghfdghfdghfghроывашоп оахп выаопыв оп11111111 pdfghd;fkgdkfsghsd[fgdiskfgh[dsfrhsdfghdgfhdshsdhsdfhfdhdsfh'gh'dskfh h[dfhgd'sfhghsdf;g hds;fhg;sdhfgsdhf222ghsdfgh [sdofhg[dsfh;kghsd ;fhg;sdfhg;sdhf;ghsdf333lghsd ;lfkgh;sdfhgosdfjhgo[sdfjhg[oisdj4444f [oihfogh]asofdg[sdifhgsj gsdhfg["
...
extension DetalViewController {
    ...
    func setupdescriptionDish() {
        ...
        descriptionDish.text = "ferferferferferf"
//        descriptionDish.text = "Здесь будет описание блюда idfuhgpidfhghadfgh[adf[ghau[dfhgadhfgadfgh[afh[gadfoh[h  jdfg;dgjsdfgsdfhjghdsfhg;dshfjhsdjgfghdfghfdghfdghfghfdghh;sdjfhg;sdfh;gsdhf;gdsh;fgj11 fsjpgohsdfsjdfkas;dkl fhpdkfhpashdfhas;dfh;sa dhsdfhhsadfgh;sadhg;fashd;fhsa"
...
extension DetalViewController {
    ...
    func setuplabelNameDish() {
        ...
        labelNameDish.text = "How to make ... Dish "
        //        labelNameDish.font = labelNameDish.font.withSize(22)
        labelNameDish.font = UIFont(name:"HelveticaNeue-Bold", size: 24.0)
...
extension DetalViewController {
    func  setcutstaint() {
        ...
        labelNameDish.backgroundColor = .red
